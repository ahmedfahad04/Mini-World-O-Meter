...
while True:
	...
	print("4.Exit")
	inp = int(input("Give input (1/2/3/4) to access COVID-19 status update accordingly\n"))
...
print(a*60+'Thanks For Being With Us'+a*36+a*20+'Edited by: AREAN'+' Coded by: FAHAD'+a*20)
#finish of program "
